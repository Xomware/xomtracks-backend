"""
RED-before-GREEN: GET /me (authed) -- the caller's linked handle(s) + a count
of shares attributed to them.
"""
...
class TestMeGet:
    ...
    def test_unlinked_user_reports_not_linked(self, tables, authorized_event, mock_context):
        from lambdas.me_get.handler import handler
    ...
    def test_linked_user_reports_handles_and_count(self, tables, authorized_event, mock_context):
